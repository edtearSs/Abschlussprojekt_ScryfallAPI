...
def app():
    ...
    st.header("Sesstion State und Dataframe Erstellung")
    st.code(session_state, language='python')
    st.header("Einzelne Kartensuche und Output")
    st.code(card_search, language='python')
    st.header("Umwandlung von Datum, Erstellung von 2 Columns + Ausgabe für den Algorithmus")
    st.code(data_science, language='python')
